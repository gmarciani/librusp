...
int main(int argc, char **argv) {
	...
	double elapsN, elapsL, elapsM, elapsH;
	double speedN, speedL, speedM, speedH;
	...
	elapsM = (end.tv_sec - start.tv_sec + (end.tv_nsec - start.tv_nsec) / 1000000000.0);

	speedM = (2.0 * (double) (NUM_ECHOS * MSGSIZE * 8.0 * 0.001)) / elapsM;
	...
	printf("\nSummary:\n");
	printf("Sent: %f KB\n", (double) NUM_ECHOS * MSGSIZE * 0.001);
